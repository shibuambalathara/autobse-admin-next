...
export const ROUTE_PERMISSIONS: Record<string, Permission> = {
  ...
  "/edit-vehicle": PERMISSIONS.VEHICLES_READ,
  ...
  "/bids-user": PERMISSIONS.USERS_READ,
  ...
  "/blocked-sellers": PERMISSIONS.USERS_READ,
  ...
  "/buying-limit": PERMISSIONS.USERS_READ,
  "/user-terms-condition": PERMISSIONS.USERS_READ,
  "/user-archived-terms-condition": PERMISSIONS.USERS_READ,
  "/event-terms-users": PERMISSIONS.EVENTS_READ,
