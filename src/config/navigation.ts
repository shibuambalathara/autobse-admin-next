...
export const NAVIGATION: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Archive,
        module: NAV_MODULES.events.id,
        permission: PERMISSIONS.ARCHIVE_EVENTS_READ,
      },
    ],
  },
  {
  ...
  },
  {
    id: "vahan-challan",
    label: "Vahan & Challan",
    href: ROUTES.proVahan,
    icon: CarFront,
    module: NAV_MODULES.system.id,
    permission: PERMISSIONS.VAHAN_CHALLAN_READ,
  },
  {
  ...
  {
    id: "split-excel",
    label: "Split Excel Files",
    href: ROUTES.splitExcel,
    icon: FileSpreadsheet,
    module: NAV_MODULES.system.id,
    permission: PERMISSIONS.SPLIT_EXCEL_READ,
  },
  {
    id: "vehicle-images",
    label: "Vehicle Image",
    href: ROUTES.vehicleImages,
    icon: Image,
    module: NAV_MODULES.system.id,
    permission: PERMISSIONS.VEHICLE_IMAGES_READ,
  },
  {
    id: "pdf-image-extract",
    label: "PDF image extract",
    href: ROUTES.pdfImageExtract,
    icon: FileText,
    module: NAV_MODULES.system.id,
    permission: PERMISSIONS.PDF_IMAGE_EXTRACT_READ,
  },
  {
    id: "notifications",
    label: "Notifications",
