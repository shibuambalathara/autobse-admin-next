...
import {
  EventBotsFilterFields,
  type EventBotsFilterFieldsProps,
} from "@/modules/event-bots/components/EventBotsFilterFields";

export type EventBotsPageToolbarProps = EventBotsFilterFieldsProps & {
  onClear: () => void;
  deletedHref?: string;
  showListActions?: boolean;
};

function countActiveFilters(props: EventBotsFilterFieldsProps) {
  let count = 0;
...
export function EventBotsPageToolbar({
  onClear,
  deletedHref = ROUTES.eventBotsDeleted,
  showListActions = true,
  ...fieldProps
}: EventBotsPageToolbarProps) {
  ...
  return (
    <div className="mb-4 w-full min-w-0 max-w-full">
        ...
        >
          ...
          {showListActions && (
            ...
            >
              ...
              <span className="truncate">EventBot</span>
            </Link>
          )}
        </div>
        ...
        {showListActions && (
          <div className="flex w-full min-w-0 flex-col gap-2">
            <Link href={deletedHref} className={mobileActionButtonClass}>
              ...
              <span className="truncate">Deleted EventBots</span>
            </Link>
          </div>
        )}
      ...
      <FilterSlideOver
        ...
        titleId="eventbots-filter-panel-title"
      >
        <EventBotsFilterFields {...fieldProps} layout="stack" />
      </FilterSlideOver>
    </div>
  );
}
