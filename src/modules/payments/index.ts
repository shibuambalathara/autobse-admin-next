export { PaymentsListView } from "./components/PaymentsListView";
export { UserPaymentsListView } from "./components/UserPaymentsListView";
...
/** @deprecated Use PaymentsListView */
export { PaymentsListView as PaymentsModuleView } from "./components/PaymentsListView";
